...
declare namespace CodeceptJS {
  export interface I {
    ...
    grabTextFrom(locator: ILocator) : Promise,
    grabTextFrom(locator: string) : Promise,
    grabHTMLFrom(locator: ILocator) : Promise,
    grabHTMLFrom(locator: string) : Promise,
    grabValueFrom(locator: ILocator) : Promise,
    grabValueFrom(locator: string) : Promise,
    ...
    grabNumberOfVisibleElements(locator: ILocator) : Promise,
    grabNumberOfVisibleElements(locator: string) : Promise,
